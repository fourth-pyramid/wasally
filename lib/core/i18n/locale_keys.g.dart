  ...
  static const Map<String, dynamic> _ar = {
    ...
    "profile": {
      ...
      "language_change_message":
          "سيتم إعادة تشغيل التطبيق بالكامل لتطبيق تغيير اللغة. هل تريد المتابعة؟",
      ...
      "delete_account_message":
          "لا يمكن التراجع عن هذا الإجراء. سيتم حذف جميع بياناتك نهائيًا. هل أنت متأكد؟",
    ...
    "privacy_policy": {
      ...
      "introduction": {
        "title": "مقدمة",
        "content":
            "تعتبر Wassaly ('نحن'، 'لنا'، أو 'نا') ملتزمه بحماية خصوصيتك. توضح سياسة الخصوصية هذه كيف نجمع، نستخدم، نكشف، ونحمي معلوماتك عند استخدامك لتطبيقنا المحمول والخدمات ذات الصلة."
      },
      "data_collection": {
        "title": "المعلومات التي نجمعها",
        "content":
            "نجمع المعلومات التي تقدمها مباشرة لنا، مثل عند إنشاء حساب، تحديث ملفك الشخصي، استخدام خدماتنا، أو الاتصال بنا للحصول على الدعم. تشمل هذه المعلومات: الاسم، عنوان البريد الإلكتروني، رقم الهاتف، معلومات الملف الشخصي، معلومات الدفع، بيانات الموقع، واستخدام البيانات."
      },
      "data_usage": {
        "title": "كيف نستخدم معلوماتك",
        "content":
            "نستخدم المعلومات التي نجمعها لتقديم خدماتنا، معالجة المعاملات وإرسال المعلومات ذات الصلة، إرسال الإشعارات الفنية ورسائل الدعم، التواصل معك حول المنتجات والخدمات والعروض الترويجية، ورصد وتحليل الاتجاهات والاستخدام."
      },
      "data_sharing": {
        "title": "مشاركة المعلومات",
        "content":
            "لا نبيع، لا نتبادل، ولا ننقل معلوماتك الشخصية إلى أطراف ثالثة دون موافقتك، باستثناء ما هو موضح في هذه السياسة. قد نشارك المعلومات مع: مقدمي الخدمات الذين يساعدون في تشغيل تطبيقنا، معالجات الدفع، وعندما يطلب القانون أو لحماية حقوقنا."
      },
      "data_security": {
        "title": "أمان البيانات",
        "content":
            "ننفذ الإجراءات الفنية والتنظيمية المناسبة لحماية معلوماتك الشخصية من الوصول غير المصرح به، التعديل، الإفصاح، أو التدمير. ومع ذلك، لا يوجد طريقة لنقل البيانات عبر الإنترنت تكون آمنة بنسبة 100%."
      },
      "user_rights": {
        "title": "حقوقك",
        "content":
            "لديك الحق في: الوصول إلى معلوماتك الشخصية وتحديثها، طلب حذف حسابك وبياناتك، إلغاء الاشتراك في الاتصالات التسويقية، وطلب نسخة من بياناتك. للقيام بهذه الحقوق، اتصل بنا باستخدام المعلومات أدناه."
      },
      "third_party": {
        "title": "خدمات الطرف الثالث",
        "content":
            "قد يحتوي تطبيقنا على روابط لمواقع وخدمات الطرف الثالث. نحن لا نتحمل مسؤولية ممارسات الخصوصية لهذه الأطراف الثالثة. نشجعك على مراجعة سياسات الخصوصية الخاصة بهم."
      },
      "children_privacy": {
        "title": "خصوصية الأطفال",
        "content":
            "خدماتنا ليست مخصصة للأطفال دون سن 13. نحن لا نجمع معلومات شخصية من الأطفال دون سن 13. إذا كنت تعتقد أننا قد جمعنا مثل هذه المعلومات، يرجى الاتصال بنا على الفور."
      },
      "international_transfers": {
        "title": "نقل البيانات الدولية",
        "content":
            "قد يتم نقل معلوماتك إلى الدول الأخرى ومعالجتها. نحن نضمن اتخاذ الإجراءات المناسبة لحماية بياناتك وفقًا لقوانين حماية البيانات المعمول بها."
      },
      "changes": {
        "title": "التغييرات على هذه السياسة",
        "content":
            "قد نحدث هذه سياسة الخصوصية من وقت لآخر. سنخبرك بأي تغييرات من خلال نشر السياسة الجديدة في التطبيق وتحديث تاريخ 'اخر تحديث'. استمرار استخدامك للتطبيق بعد مثل هذه التغييرات يشكل قبولًا."
      },
      "contact": {
        "title": "اتصل بنا",
        "content":
            "إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا على: privacy@wassaly.com أو من خلال مركز الدعم داخل التطبيق."
      },
      "footer": {
        "note":
            "باستخدام Wassaly، أنت تقر بأنك قد قرأت وفهمت سياسة الخصوصية هذه."
      },
